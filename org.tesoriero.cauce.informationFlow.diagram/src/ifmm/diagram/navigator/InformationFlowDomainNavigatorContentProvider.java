 ...
 * @generated
 */
public class InformationFlowDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public InformationFlowDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof InformationFlowDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((InformationFlowDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new InformationFlowDomainNavigatorItem(
