 ...
 * @generated
 */
public class InitialConditionLogicExpressionEditPart extends
	 ...
	 * @generated
	 */
	public InitialConditionLogicExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.InitialConditionLogicExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
