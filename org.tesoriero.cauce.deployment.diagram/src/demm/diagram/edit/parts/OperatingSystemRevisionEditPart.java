 ...
 * @generated
 */
public class OperatingSystemRevisionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OperatingSystemRevisionEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.OperatingSystemRevisionEditPart.VISUAL_ID));
		}
		return parser;
	}
