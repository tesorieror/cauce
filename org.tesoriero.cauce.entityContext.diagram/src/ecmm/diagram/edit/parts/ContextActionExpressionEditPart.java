 ...
 * @generated
 */
public class ContextActionExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ContextActionExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.ContextActionExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
