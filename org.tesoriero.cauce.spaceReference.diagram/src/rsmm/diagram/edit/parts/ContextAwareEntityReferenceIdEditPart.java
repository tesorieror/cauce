 ...
 * @generated
 */
public class ContextAwareEntityReferenceIdEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ContextAwareEntityReferenceIdEditPart(View view) {
		super(view);
	}
			...
			parser = SpaceReferenceParserProvider
					.getParser(
							...
							SpaceReferenceVisualIDRegistry
									.getType(rsmm.diagram.edit.parts.ContextAwareEntityReferenceIdEditPart.VISUAL_ID));
		}
		return parser;
	}
