 ...
 * @generated
 */
public class TaskValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = TaskDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof TaskDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ContextAwareSystemEditPart.MODEL_ID
						.equals(TaskVisualIDRegistry.getModelID(view));
	}
