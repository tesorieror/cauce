...
import demm.diagram.part.DeploymentDiagramEditorUtil;

/**
 * @generated
 */
public class DeploymentMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = DeploymentDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			DeploymentDiagramEditorUtil.selectElementsInDiagram(editor,
