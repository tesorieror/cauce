...
/**
 * This is the item provider adapter for a {@link demm.Protocol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProtocolItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemmPackage.Literals.PROTOCOL__NAME,
				 true,
				 false,
				 false,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Protocol_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Protocol_version_feature", "_UI_Protocol_type"),
				 DemmPackage.Literals.PROTOCOL__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Protocol.class)) {
			case DemmPackage.PROTOCOL__NAME:
			case DemmPackage.PROTOCOL__VERSION:
