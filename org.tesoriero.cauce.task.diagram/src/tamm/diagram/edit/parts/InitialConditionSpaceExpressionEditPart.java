 ...
 * @generated
 */
public class InitialConditionSpaceExpressionEditPart extends
	 ...
	 * @generated
	 */
	public InitialConditionSpaceExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.InitialConditionSpaceExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
