 ...
 * @generated
 */
public class HolderMemoryIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HolderMemoryIdEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.HolderMemoryIdEditPart.VISUAL_ID));
		}
		return parser;
	}
