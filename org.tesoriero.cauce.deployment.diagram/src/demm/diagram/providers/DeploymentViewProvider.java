 ...
 * @generated
 */
public class DeploymentViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return DevelopmentEnvironmentEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = DeploymentVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = DeploymentVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!DeploymentElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != DeploymentVisualIDRegistry
				...
				if (!DevelopmentEnvironmentEditPart.MODEL_ID
						.equals(DeploymentVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return ProgrammingLanguageEditPart.VISUAL_ID == visualID
				|| OperatingSystemEditPart.VISUAL_ID == visualID
				|| DeviceEditPart.VISUAL_ID == visualID
				|| ConnectionEditPart.VISUAL_ID == visualID
				|| MediumEditPart.VISUAL_ID == visualID
				|| ProtocolEditPart.VISUAL_ID == visualID
				|| DevicePlatformEditPart.VISUAL_ID == visualID
				|| EntityEditPart.VISUAL_ID == visualID
				|| InformationEditPart.VISUAL_ID == visualID
				|| ConnectionPlatformEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = DeploymentVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != DeploymentVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(DevelopmentEnvironmentEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = DeploymentVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ProgrammingLanguageEditPart.VISUAL_ID:
			return createProgrammingLanguage_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case OperatingSystemEditPart.VISUAL_ID:
			return createOperatingSystem_2002(domainElement, containerView,
					index, persisted, preferencesHint);
		case DeviceEditPart.VISUAL_ID:
			return createDevice_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ConnectionEditPart.VISUAL_ID:
			return createConnection_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case MediumEditPart.VISUAL_ID:
			return createMedium_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case ProtocolEditPart.VISUAL_ID:
			return createProtocol_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case DevicePlatformEditPart.VISUAL_ID:
			return createDevicePlatform_3001(domainElement, containerView,
					index, persisted, preferencesHint);
		case EntityEditPart.VISUAL_ID:
			return createEntity_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case InformationEditPart.VISUAL_ID:
			return createInformation_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case ConnectionPlatformEditPart.VISUAL_ID:
			return createConnectionPlatform_3004(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (DeploymentVisualIDRegistry.getVisualID(elementTypeHint)) {
		case DeviceToConnectionEdgeEditPart.VISUAL_ID:
			return createDeviceToConnectionEdge_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ConnectionToDeviceEdgeEditPart.VISUAL_ID:
			return createConnectionToDeviceEdge_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createProgrammingLanguage_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DeploymentVisualIDRegistry
		...
		Node label5002 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(ProgrammingLanguageProfileEditPart.VISUAL_ID));
		Node label5003 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(ProgrammingLanguageVersionEditPart.VISUAL_ID));
		Node label5004 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(ProgrammingLanguageRevisionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createOperatingSystem_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5006 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(OperatingSystemVersionEditPart.VISUAL_ID));
		Node label5007 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(OperatingSystemRevisionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createDevice_2003(EObject domainElement, View containerView,
		...
		Node label5012 = createLabel(node,
				DeploymentVisualIDRegistry.getType(DeviceIdEditPart.VISUAL_ID));
		createCompartment(
				node,
				DeploymentVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createConnection_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label5017 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(ConnectionIdEditPart.VISUAL_ID));
		createCompartment(
				node,
				DeploymentVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createMedium_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DeploymentVisualIDRegistry
		...
		Node label5019 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(MediumTypeEditPart.VISUAL_ID));
		Node label5020 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(MediumTechnologyEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createProtocol_2006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(DeploymentVisualIDRegistry
		...
		Node label5022 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(ProtocolVersionEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createDevicePlatform_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5009 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(DevicePlatformIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createInformation_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createConnectionPlatform_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5015 = createLabel(node,
				DeploymentVisualIDRegistry
						.getType(ConnectionPlatformIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createDeviceToConnectionEdge_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(DeploymentVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createConnectionToDeviceEdge_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!DevelopmentEnvironmentEditPart.MODEL_ID
				.equals(DeploymentVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", DevelopmentEnvironmentEditPart.MODEL_ID); //$NON-NLS-1$
