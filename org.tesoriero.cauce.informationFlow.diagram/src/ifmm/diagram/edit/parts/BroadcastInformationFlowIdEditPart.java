 ...
 * @generated
 */
public class BroadcastInformationFlowIdEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public BroadcastInformationFlowIdEditPart(View view) {
		super(view);
	}
			...
			parser = InformationFlowParserProvider
					.getParser(
							...
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.BroadcastInformationFlowIdEditPart.VISUAL_ID));
		}
		return parser;
	}
