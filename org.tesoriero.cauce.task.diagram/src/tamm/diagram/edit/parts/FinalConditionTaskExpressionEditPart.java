 ...
 * @generated
 */
public class FinalConditionTaskExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FinalConditionTaskExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.FinalConditionTaskExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
