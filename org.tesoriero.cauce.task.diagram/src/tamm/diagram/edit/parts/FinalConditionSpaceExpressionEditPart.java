 ...
 * @generated
 */
public class FinalConditionSpaceExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FinalConditionSpaceExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.FinalConditionSpaceExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
