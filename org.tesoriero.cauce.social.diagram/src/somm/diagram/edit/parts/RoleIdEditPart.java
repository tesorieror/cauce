 ...
 * @generated
 */
public class RoleIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RoleIdEditPart(View view) {
		super(view);
	}
			...
			parser = SocialParserProvider
					.getParser(
							...
							SocialVisualIDRegistry
									.getType(somm.diagram.edit.parts.RoleIdEditPart.VISUAL_ID));
		}
		return parser;
	}
