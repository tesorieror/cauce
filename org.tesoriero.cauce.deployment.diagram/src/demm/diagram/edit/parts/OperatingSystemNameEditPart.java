 ...
 * @generated
 */
public class OperatingSystemNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OperatingSystemNameEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.OperatingSystemNameEditPart.VISUAL_ID));
		}
		return parser;
	}
