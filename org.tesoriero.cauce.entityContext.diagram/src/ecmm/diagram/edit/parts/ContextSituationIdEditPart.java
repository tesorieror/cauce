 ...
 * @generated
 */
public class ContextSituationIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ContextSituationIdEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new EntityContextTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return EntityContextElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EntityContextParserProvider
					.getParser(
							EntityContextElementTypes.ContextSituation_3006,
							getParserElement(),
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.ContextSituationIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					EntityContextEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
