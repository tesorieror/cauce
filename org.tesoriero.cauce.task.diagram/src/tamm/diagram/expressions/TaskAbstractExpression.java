 ...
 * @generated
 */
public abstract class TaskAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = TaskDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected TaskAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
