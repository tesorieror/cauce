...
/**
 * This is the item provider adapter for a {@link demm.ProgrammingLanguage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgrammingLanguageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemmPackage.Literals.PROGRAMMING_LANGUAGE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemmPackage.Literals.PROGRAMMING_LANGUAGE__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addProfilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProgrammingLanguage_profile_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProgrammingLanguage_profile_feature", "_UI_ProgrammingLanguage_type"),
				 DemmPackage.Literals.PROGRAMMING_LANGUAGE__PROFILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRevisionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProgrammingLanguage_revision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProgrammingLanguage_revision_feature", "_UI_ProgrammingLanguage_type"),
				 DemmPackage.Literals.PROGRAMMING_LANGUAGE__REVISION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
