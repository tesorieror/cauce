...
/**
 * This is the item provider adapter for a {@link spmm.Representation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepresentationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Representation_represents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Representation_represents_feature", "_UI_Representation_type"),
				 SpmmPackage.Literals.REPRESENTATION__REPRESENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRepresentedByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Representation_representedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Representation_representedBy_feature", "_UI_Representation_type"),
				 SpmmPackage.Literals.REPRESENTATION__REPRESENTED_BY,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Representation_type") + " " + representation.getId();
	}
