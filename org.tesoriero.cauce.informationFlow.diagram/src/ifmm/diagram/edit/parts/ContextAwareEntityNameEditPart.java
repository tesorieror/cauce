 ...
 * @generated
 */
public class ContextAwareEntityNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ContextAwareEntityNameEditPart(View view) {
		super(view);
	}
			...
			parser = InformationFlowParserProvider
					.getParser(
							...
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.ContextAwareEntityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
