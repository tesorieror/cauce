 ...
 * @generated
 */
public class FinalConditionLogicExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FinalConditionLogicExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.FinalConditionLogicExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
