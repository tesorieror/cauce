 ...
 * @generated
 */
public class ProgrammingLanguageVersionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ProgrammingLanguageVersionEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.ProgrammingLanguageVersionEditPart.VISUAL_ID));
		}
		return parser;
	}
