 ...
 * @generated
 */
public class InformationFlowInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new InformationFlowNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SystemInformaitonFlowEditPart.MODEL_ID));
		InformationFlowDiagramEditorUtil.runWizard(getShell(), wizard,
