 ...
 * @generated
 */
public class DictionaryMemoryNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DictionaryMemoryNameEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.DictionaryMemoryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
