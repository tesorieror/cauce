 ...
 * @generated
 */
public class ProgrammingLanguageRevisionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ProgrammingLanguageRevisionEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.ProgrammingLanguageRevisionEditPart.VISUAL_ID));
		}
		return parser;
	}
