 ...
 * @generated
 */
public class DevicePlatformIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DevicePlatformIdEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.DevicePlatformIdEditPart.VISUAL_ID));
		}
		return parser;
	}
