 ...
 * @generated
 */
public class EntityContextDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public EntityContextDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof EntityContextDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((EntityContextDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new EntityContextDomainNavigatorItem(
