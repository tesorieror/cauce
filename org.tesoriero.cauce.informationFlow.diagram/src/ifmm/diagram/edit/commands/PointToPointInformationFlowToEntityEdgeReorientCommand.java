 ...
 * @generated
 */
public class PointToPointInformationFlowToEntityEdgeReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public PointToPointInformationFlowToEntityEdgeReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof PointToPointInformationFlowToEntityEdge) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return InformationFlowBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPointToPointInformationFlowToEntityEdge_4004(
	...
	protected boolean canReorientTarget() {
		...
		PointToPointInformationFlow source = getLink().getSource();
		if (!(getLink().eContainer() instanceof SystemInformaitonFlow)) {
			return false;
		}
		SystemInformaitonFlow container = (SystemInformaitonFlow) getLink()
	 ...
	 * @generated
	 */
	protected PointToPointInformationFlowToEntityEdge getLink() {
		return (PointToPointInformationFlowToEntityEdge) getElementToEdit();
	}

	/**
	 * @generated
	 */
	protected PointToPointInformationFlow getOldSource() {
	 ...
	 * @generated
	 */
	protected PointToPointInformationFlow getNewSource() {
