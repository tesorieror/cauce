 ...
 * @generated
 */
public class SpaceReferenceInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SpaceReferenceNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SystemInformationFlowReferenceSpaceEditPart.MODEL_ID));
		SpaceReferenceDiagramEditorUtil.runWizard(getShell(), wizard,
