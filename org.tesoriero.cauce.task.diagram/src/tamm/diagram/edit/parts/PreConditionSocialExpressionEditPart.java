 ...
 * @generated
 */
public class PreConditionSocialExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PreConditionSocialExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PreConditionSocialExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
