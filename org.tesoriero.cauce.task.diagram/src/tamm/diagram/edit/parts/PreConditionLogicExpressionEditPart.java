 ...
 * @generated
 */
public class PreConditionLogicExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PreConditionLogicExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PreConditionLogicExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
