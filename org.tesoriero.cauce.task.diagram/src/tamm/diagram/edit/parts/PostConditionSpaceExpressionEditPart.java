 ...
 * @generated
 */
public class PostConditionSpaceExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PostConditionSpaceExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PostConditionSpaceExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
