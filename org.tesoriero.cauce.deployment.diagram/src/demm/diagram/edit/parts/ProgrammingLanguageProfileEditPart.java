 ...
 * @generated
 */
public class ProgrammingLanguageProfileEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ProgrammingLanguageProfileEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.ProgrammingLanguageProfileEditPart.VISUAL_ID));
		}
		return parser;
	}
