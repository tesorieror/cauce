 ...
 * @generated
 */
public class MediumTechnologyEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MediumTechnologyEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.MediumTechnologyEditPart.VISUAL_ID));
		}
		return parser;
	}
