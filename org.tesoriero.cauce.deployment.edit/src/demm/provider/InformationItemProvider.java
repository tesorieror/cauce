...
/**
 * This is the item provider adapter for a {@link demm.Information} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InformationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Information_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Information_name_feature", "_UI_Information_type"),
				 DemmPackage.Literals.INFORMATION__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Information.class)) {
			case DemmPackage.INFORMATION__NAME:
