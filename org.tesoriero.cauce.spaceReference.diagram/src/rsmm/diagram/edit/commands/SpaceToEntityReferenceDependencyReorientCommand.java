 ...
 * @generated
 */
public class SpaceToEntityReferenceDependencyReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public SpaceToEntityReferenceDependencyReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof SpaceToEntityReferenceDependency) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		ContextAwareEntityReference target = getLink().getChild();
		...
		return SpaceReferenceBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSpaceToEntityReferenceDependency_4002(container,
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof ContextAwareEntityReference && newEnd instanceof ContextAwareEntityReference)) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected SpaceToEntityReferenceDependency getLink() {
		return (SpaceToEntityReferenceDependency) getElementToEdit();
	}
	 ...
	 * @generated
	 */
	protected ContextAwareEntityReference getOldTarget() {
		return (ContextAwareEntityReference) oldEnd;
	}

	/**
	 * @generated
	 */
	protected ContextAwareEntityReference getNewTarget() {
		return (ContextAwareEntityReference) newEnd;
	}
}
