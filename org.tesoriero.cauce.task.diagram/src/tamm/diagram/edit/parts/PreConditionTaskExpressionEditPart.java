 ...
 * @generated
 */
public class PreConditionTaskExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PreConditionTaskExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PreConditionTaskExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
