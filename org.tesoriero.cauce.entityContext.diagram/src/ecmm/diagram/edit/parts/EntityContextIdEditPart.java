 ...
 * @generated
 */
public class EntityContextIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EntityContextIdEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.EntityContextIdEditPart.VISUAL_ID));
		}
		return parser;
	}
