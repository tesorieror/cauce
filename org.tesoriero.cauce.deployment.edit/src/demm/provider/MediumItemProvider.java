...
/**
 * This is the item provider adapter for a {@link demm.Medium} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MediumItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Medium_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Medium_type_feature", "_UI_Medium_type"),
				 DemmPackage.Literals.MEDIUM__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addTechnologyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Medium_technology_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Medium_technology_feature", "_UI_Medium_type"),
				 DemmPackage.Literals.MEDIUM__TECHNOLOGY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Medium_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Medium_version_feature", "_UI_Medium_type"),
				 DemmPackage.Literals.MEDIUM__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Medium)object).getType();
