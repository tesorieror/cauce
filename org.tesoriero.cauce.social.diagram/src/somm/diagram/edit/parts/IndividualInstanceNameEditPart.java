 ...
 * @generated
 */
public class IndividualInstanceNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				SocialVisualIDRegistry
						.getType(somm.diagram.edit.parts.IndividualInstanceNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public IndividualInstanceNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SocialTextSelectionEditPolicy());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					SocialEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new InstanceNameFigure();
	}

	/**
	 * @generated
	 */
	public class InstanceNameFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureIntanceNameLabelFigure;
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureIntanceNameLabelFigure() {
			return fFigureIntanceNameLabelFigure;
		}
