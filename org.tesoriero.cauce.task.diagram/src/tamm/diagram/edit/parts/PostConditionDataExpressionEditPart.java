 ...
 * @generated
 */
public class PostConditionDataExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PostConditionDataExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PostConditionDataExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
