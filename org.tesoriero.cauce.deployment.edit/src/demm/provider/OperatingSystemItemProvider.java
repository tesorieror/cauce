...
/**
 * This is the item provider adapter for a {@link demm.OperatingSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperatingSystem_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperatingSystem_name_feature", "_UI_OperatingSystem_type"),
				 DemmPackage.Literals.OPERATING_SYSTEM__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemmPackage.Literals.OPERATING_SYSTEM__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRevisionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperatingSystem_revision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperatingSystem_revision_feature", "_UI_OperatingSystem_type"),
				 DemmPackage.Literals.OPERATING_SYSTEM__REVISION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
