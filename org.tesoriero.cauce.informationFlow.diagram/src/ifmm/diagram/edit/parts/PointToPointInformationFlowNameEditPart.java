 ...
 * @generated
 */
public class PointToPointInformationFlowNameEditPart extends
	 ...
	 * @generated
	 */
	public PointToPointInformationFlowNameEditPart(View view) {
		super(view);
	}
			...
			parser = InformationFlowParserProvider
					.getParser(
							...
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.PointToPointInformationFlowNameEditPart.VISUAL_ID));
		}
		return parser;
	}
