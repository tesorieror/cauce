 ...
 * @generated
 */
public class ConnectionToDeviceEdgeCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final DevelopmentEnvironment container;

	/**
	 * @generated
	 */
	public ConnectionToDeviceEdgeCreateCommand(
	...
	public boolean canExecute() {
		...
		return DeploymentBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateConnectionToDeviceEdge_4002(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ConnectionToDeviceEdge newElement = DemmFactory.eINSTANCE
				.createConnectionToDeviceEdge();
	 ...
	 * @generated
	 */
	protected void doConfigure(ConnectionToDeviceEdge newElement,
	 ...
	 * @generated
	 */
	public DevelopmentEnvironment getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static DevelopmentEnvironment deduceContainer(EObject source,
			EObject target) {
		...
		for (EObject element = source; element != null; element = element
			...
			if (element instanceof DevelopmentEnvironment) {
				return (DevelopmentEnvironment) element;
			}
		}
		return null;
	}
