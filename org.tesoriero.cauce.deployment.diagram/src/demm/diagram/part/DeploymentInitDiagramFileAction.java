 ...
 * @generated
 */
public class DeploymentInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new DeploymentNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				DevelopmentEnvironmentEditPart.MODEL_ID));
		DeploymentDiagramEditorUtil.runWizard(getShell(), wizard,
