 ...
 * @generated
 */
public class ConnectionPlatformIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConnectionPlatformIdEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new DeploymentTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return DeploymentElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeploymentParserProvider
					.getParser(
							DeploymentElementTypes.ConnectionPlatform_3004,
							getParserElement(),
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.ConnectionPlatformIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					DeploymentEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
