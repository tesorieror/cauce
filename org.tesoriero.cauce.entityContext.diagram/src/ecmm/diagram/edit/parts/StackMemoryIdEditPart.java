 ...
 * @generated
 */
public class StackMemoryIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StackMemoryIdEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.StackMemoryIdEditPart.VISUAL_ID));
		}
		return parser;
	}
