 ...
 * @generated
 */
public class SensingContextConditionInformationflowEditPart extends
	 ...
	 * @generated
	 */
	public SensingContextConditionInformationflowEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.SensingContextConditionInformationflowEditPart.VISUAL_ID));
		}
		return parser;
	}
