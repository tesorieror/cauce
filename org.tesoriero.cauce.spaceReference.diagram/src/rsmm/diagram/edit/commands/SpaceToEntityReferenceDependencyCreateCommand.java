 ...
 * @generated
 */
public class SpaceToEntityReferenceDependencyCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public SpaceToEntityReferenceDependencyCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null
				&& false == target instanceof ContextAwareEntityReference) {
			return false;
		}
		if (getSource() == null) {
		...
		return SpaceReferenceBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateSpaceToEntityReferenceDependency_4002(getContainer(),
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		SpaceToEntityReferenceDependency newElement = RsmmFactory.eINSTANCE
				.createSpaceToEntityReferenceDependency();
		getContainer().getSpaceToEntityReferenceDependencies().add(newElement);
		newElement.setParent(getSource());
		newElement.setChild(getTarget());
		ElementInitializers.getInstance()
				.init_SpaceToEntityReferenceDependency_4002(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(SpaceToEntityReferenceDependency newElement,
	 ...
	 * @generated
	 */
	protected ContextAwareEntityReference getTarget() {
		return (ContextAwareEntityReference) target;
	}
