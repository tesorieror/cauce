 ...
 * @generated
 */
public class PostConditionLogicExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PostConditionLogicExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PostConditionLogicExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
