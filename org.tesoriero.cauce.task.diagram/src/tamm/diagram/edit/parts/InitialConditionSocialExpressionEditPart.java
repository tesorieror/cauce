 ...
 * @generated
 */
public class InitialConditionSocialExpressionEditPart extends
	 ...
	 * @generated
	 */
	public InitialConditionSocialExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.InitialConditionSocialExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
