...
import spmm.diagram.edit.policies.SpaceTextSelectionEditPolicy;
 ...
 * @generated
 */
public class PhysicalSpaceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PhysicalSpaceNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SpaceTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return SpaceElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SpaceParserProvider
					.getParser(
							SpaceElementTypes.PhysicalSpace_2001,
							getParserElement(),
							SpaceVisualIDRegistry
									.getType(spmm.diagram.edit.parts.PhysicalSpaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					SpaceEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
