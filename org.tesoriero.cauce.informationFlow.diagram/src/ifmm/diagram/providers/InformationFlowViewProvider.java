 ...
 * @generated
 */
public class InformationFlowViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SystemInformaitonFlowEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = InformationFlowVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = InformationFlowVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!InformationFlowElementTypes
				...
				if (domainElement != null
						&& visualID != InformationFlowVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!SystemInformaitonFlowEditPart.MODEL_ID
						.equals(InformationFlowVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return BroadcastInformationFlowEditPart.VISUAL_ID == visualID
				|| PointToPointInformationFlowEditPart.VISUAL_ID == visualID
				|| ContextAwareEntityEditPart.VISUAL_ID == visualID
				|| OutputDataEditPart.VISUAL_ID == visualID
				|| OutputData2EditPart.VISUAL_ID == visualID
				|| InputDataEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op
				.getSemanticAdapter());
		if (!InformationFlowElementTypes.isKnownElementType(elementType)
				|| (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		...
		int visualID = InformationFlowVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(SystemInformaitonFlowEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case BroadcastInformationFlowEditPart.VISUAL_ID:
			return createBroadcastInformationFlow_2001(domainElement,
					containerView, index, persisted, preferencesHint);
		case PointToPointInformationFlowEditPart.VISUAL_ID:
			return createPointToPointInformationFlow_2002(domainElement,
					containerView, index, persisted, preferencesHint);
		case ContextAwareEntityEditPart.VISUAL_ID:
			return createContextAwareEntity_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case OutputDataEditPart.VISUAL_ID:
			return createOutputData_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case OutputData2EditPart.VISUAL_ID:
			return createOutputData_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case InputDataEditPart.VISUAL_ID:
			return createInputData_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (InformationFlowVisualIDRegistry.getVisualID(elementTypeHint)) {
		case BroadcastInformationFlowToEntityEdgeEditPart.VISUAL_ID:
			return createBroadcastInformationFlowToEntityEdge_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case EntityToBroadcastInformationFlowEdgeEditPart.VISUAL_ID:
			return createEntityToBroadcastInformationFlowEdge_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case EntityToPointToPointInformationFlowEdgeEditPart.VISUAL_ID:
			return createEntityToPointToPointInformationFlowEdge_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case PointToPointInformationFlowToEntityEdgeEditPart.VISUAL_ID:
			return createPointToPointInformationFlowToEntityEdge_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createBroadcastInformationFlow_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(InformationFlowVisualIDRegistry
		...
		Node label5003 = createLabel(node,
				InformationFlowVisualIDRegistry
						.getType(BroadcastInformationFlowIdEditPart.VISUAL_ID));
		createCompartment(
				node,
				InformationFlowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createPointToPointInformationFlow_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5007 = createLabel(
				node,
				InformationFlowVisualIDRegistry
						.getType(PointToPointInformationFlowIdEditPart.VISUAL_ID));
		createCompartment(
				node,
				InformationFlowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createContextAwareEntity_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5009 = createLabel(node,
				InformationFlowVisualIDRegistry
						.getType(ContextAwareEntityIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createOutputData_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createOutputData_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createInputData_3003(EObject domainElement, View containerView,
	 ...
	 * @generated
	 */
	public Edge createBroadcastInformationFlowToEntityEdge_4001(
		...
		edge.setType(InformationFlowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createEntityToBroadcastInformationFlowEdge_4002(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createEntityToPointToPointInformationFlowEdge_4003(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createPointToPointInformationFlowToEntityEdge_4004(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!SystemInformaitonFlowEditPart.MODEL_ID
			...
			shortcutAnnotation.getDetails().put(
					"modelID", SystemInformaitonFlowEditPart.MODEL_ID); //$NON-NLS-1$
