...
import spmm.diagram.part.SpaceDiagramEditorUtil;

/**
 * @generated
 */
public class SpaceMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = SpaceDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			SpaceDiagramEditorUtil.selectElementsInDiagram(editor,
