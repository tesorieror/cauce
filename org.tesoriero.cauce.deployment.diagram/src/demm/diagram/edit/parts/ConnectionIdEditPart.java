 ...
 * @generated
 */
public class ConnectionIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ConnectionIdEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.ConnectionIdEditPart.VISUAL_ID));
		}
		return parser;
	}
