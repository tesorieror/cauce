 ...
 * @generated
 */
public abstract class SpaceReferenceAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SpaceReferenceDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected SpaceReferenceAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
