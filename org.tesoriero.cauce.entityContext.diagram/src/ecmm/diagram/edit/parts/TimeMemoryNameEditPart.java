 ...
 * @generated
 */
public class TimeMemoryNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TimeMemoryNameEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.TimeMemoryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
