...
import somm.diagram.part.SocialDiagramEditorUtil;

/**
 * @generated
 */
public class SocialMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = SocialDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			SocialDiagramEditorUtil.selectElementsInDiagram(editor,
