...
import demm.diagram.part.DeploymentDiagramEditor;
 ...
 * @generated
 */
public class DeploymentNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof DeploymentNavigatorItem) {
					selectedElement = ((DeploymentNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, DeploymentDiagramEditor.ID);
