 ...
 * @generated
 */
public abstract class InformationFlowAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = InformationFlowDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected InformationFlowAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
