 ...
 * @generated
 */
public class PreConditionSpaceExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PreConditionSpaceExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PreConditionSpaceExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
