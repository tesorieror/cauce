 ...
 * @generated
 */
public class ConnectionPlatformNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ConnectionPlatformNameEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.ConnectionPlatformNameEditPart.VISUAL_ID));
		}
		return parser;
	}
