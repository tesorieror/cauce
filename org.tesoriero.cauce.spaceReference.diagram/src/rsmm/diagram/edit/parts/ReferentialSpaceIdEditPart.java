 ...
 * @generated
 */
public class ReferentialSpaceIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ReferentialSpaceIdEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SpaceReferenceTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return SpaceReferenceElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SpaceReferenceParserProvider
					.getParser(
							SpaceReferenceElementTypes.ReferentialSpace_2002,
							getParserElement(),
							SpaceReferenceVisualIDRegistry
									.getType(rsmm.diagram.edit.parts.ReferentialSpaceIdEditPart.VISUAL_ID));
		}
		return parser;
	}
