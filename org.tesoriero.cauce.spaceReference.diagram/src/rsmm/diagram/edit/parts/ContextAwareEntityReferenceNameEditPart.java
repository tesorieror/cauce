 ...
 * @generated
 */
public class ContextAwareEntityReferenceNameEditPart extends
	 ...
	 * @generated
	 */
	public ContextAwareEntityReferenceNameEditPart(View view) {
		super(view);
	}
			...
			parser = SpaceReferenceParserProvider
					.getParser(
							...
							SpaceReferenceVisualIDRegistry
									.getType(rsmm.diagram.edit.parts.ContextAwareEntityReferenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
