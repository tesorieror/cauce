...
import ecmm.diagram.part.EntityContextDiagramEditor;
 ...
 * @generated
 */
public class EntityContextNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof EntityContextNavigatorItem) {
					selectedElement = ((EntityContextNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (SystemContextEditPart.MODEL_ID
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, EntityContextDiagramEditor.ID);
