 ...
 * @generated
 */
public class SpaceReferenceViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SystemInformationFlowReferenceSpaceEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = SpaceReferenceVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = SpaceReferenceVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!SpaceReferenceElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != SpaceReferenceVisualIDRegistry
				...
				if (!SystemInformationFlowReferenceSpaceEditPart.MODEL_ID
						.equals(SpaceReferenceVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return ContextAwareEntityReferenceEditPart.VISUAL_ID == visualID
				|| ReferentialSpaceEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = SpaceReferenceVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(SystemInformationFlowReferenceSpaceEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = SpaceReferenceVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ContextAwareEntityReferenceEditPart.VISUAL_ID:
			return createContextAwareEntityReference_2001(domainElement,
					containerView, index, persisted, preferencesHint);
		case ReferentialSpaceEditPart.VISUAL_ID:
			return createReferentialSpace_2002(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (SpaceReferenceVisualIDRegistry.getVisualID(elementTypeHint)) {
		case SpaceToSpaceReferenceDependencyEditPart.VISUAL_ID:
			return createSpaceToSpaceReferenceDependency_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case SpaceToEntityReferenceDependencyEditPart.VISUAL_ID:
			return createSpaceToEntityReferenceDependency_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createContextAwareEntityReference_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SpaceReferenceVisualIDRegistry
		...
		Node label5002 = createLabel(
				node,
				SpaceReferenceVisualIDRegistry
						.getType(ContextAwareEntityReferenceEntityEditPart.VISUAL_ID));
		Node label5003 = createLabel(
				node,
				SpaceReferenceVisualIDRegistry
						.getType(ContextAwareEntityReferenceIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createReferentialSpace_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		Node label5005 = createLabel(node,
				SpaceReferenceVisualIDRegistry
						.getType(ReferentialSpaceIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createSpaceToSpaceReferenceDependency_4001(
		...
		edge.setType(SpaceReferenceVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createSpaceToEntityReferenceDependency_4002(
			EObject domainElement, View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!SystemInformationFlowReferenceSpaceEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", SystemInformationFlowReferenceSpaceEditPart.MODEL_ID); //$NON-NLS-1$
