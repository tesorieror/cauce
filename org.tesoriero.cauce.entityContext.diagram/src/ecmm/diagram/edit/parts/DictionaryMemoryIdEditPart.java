 ...
 * @generated
 */
public class DictionaryMemoryIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DictionaryMemoryIdEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EntityContextParserProvider
					.getParser(
							EntityContextElementTypes.DictionaryMemory_3005,
							getParserElement(),
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.DictionaryMemoryIdEditPart.VISUAL_ID));
		}
		return parser;
	}
