 ...
 * @generated
 */
public abstract class EntityContextAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = EntityContextDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected EntityContextAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
