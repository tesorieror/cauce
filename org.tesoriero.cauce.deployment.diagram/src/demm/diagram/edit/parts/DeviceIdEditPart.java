 ...
 * @generated
 */
public class DeviceIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DeviceIdEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.DeviceIdEditPart.VISUAL_ID));
		}
		return parser;
	}
