 ...
 * @generated
 */
public class ContextAwareEntityReferenceEntityEditPart extends
	 ...
	 * @generated
	 */
	public ContextAwareEntityReferenceEntityEditPart(View view) {
		super(view);
	}
			...
			parser = SpaceReferenceParserProvider
					.getParser(
							...
							SpaceReferenceVisualIDRegistry
									.getType(rsmm.diagram.edit.parts.ContextAwareEntityReferenceEntityEditPart.VISUAL_ID));
		}
		return parser;
	}
