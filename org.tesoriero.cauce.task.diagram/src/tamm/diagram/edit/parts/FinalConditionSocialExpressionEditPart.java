 ...
 * @generated
 */
public class FinalConditionSocialExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public FinalConditionSocialExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.FinalConditionSocialExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
