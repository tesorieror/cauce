 ...
 * @generated
 */
public class TimeMemoryIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TimeMemoryIdEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.TimeMemoryIdEditPart.VISUAL_ID));
		}
		return parser;
	}
