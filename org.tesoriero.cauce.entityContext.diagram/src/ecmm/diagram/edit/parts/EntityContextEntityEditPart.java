 ...
 * @generated
 */
public class EntityContextEntityEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EntityContextEntityEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.EntityContextEntityEditPart.VISUAL_ID));
		}
		return parser;
	}
