...
import tamm.diagram.part.TaskDiagramEditorUtil;

/**
 * @generated
 */
public class TaskMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = TaskDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			TaskDiagramEditorUtil.selectElementsInDiagram(editor,
