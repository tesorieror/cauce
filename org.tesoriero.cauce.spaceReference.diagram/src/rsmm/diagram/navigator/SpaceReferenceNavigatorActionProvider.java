...
import rsmm.diagram.part.SpaceReferenceDiagramEditor;
 ...
 * @generated
 */
public class SpaceReferenceNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof SpaceReferenceNavigatorItem) {
					selectedElement = ((SpaceReferenceNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, SpaceReferenceDiagramEditor.ID);
