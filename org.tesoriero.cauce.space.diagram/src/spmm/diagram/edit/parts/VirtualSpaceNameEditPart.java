 ...
 * @generated
 */
public class VirtualSpaceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public VirtualSpaceNameEditPart(View view) {
		super(view);
	}
			...
			parser = SpaceParserProvider
					.getParser(
							...
							SpaceVisualIDRegistry
									.getType(spmm.diagram.edit.parts.VirtualSpaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
