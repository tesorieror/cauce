 ...
 * @generated
 */
public class ContextSituationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ContextSituationNameEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.ContextSituationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
