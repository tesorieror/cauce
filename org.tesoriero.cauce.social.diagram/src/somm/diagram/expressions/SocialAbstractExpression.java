 ...
 * @generated
 */
public abstract class SocialAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SocialDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected SocialAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
