 ...
 * @generated
 */
public class OutputDataDefinitionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OutputDataDefinitionEditPart(View view) {
		super(view);
	}
			...
			parser = InformationFlowParserProvider
					.getParser(
							...
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.OutputDataDefinitionEditPart.VISUAL_ID));
		}
		return parser;
	}
