 ...
 * @generated
 */
public class EntityContextInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new EntityContextNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SystemContextEditPart.MODEL_ID));
		EntityContextDiagramEditorUtil.runWizard(getShell(), wizard,
