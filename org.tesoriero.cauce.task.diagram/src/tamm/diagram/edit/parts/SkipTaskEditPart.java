...
import tamm.diagram.edit.policies.SkipTaskItemSemanticEditPolicy;
...
public class SkipTaskEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SkipTaskEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SkipTaskItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new SkipTaskFigure();
	}

	/**
	 * @generated
	 */
	public SkipTaskFigure getPrimaryShape() {
		return (SkipTaskFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class SkipTaskFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		public SkipTaskFigure() {
