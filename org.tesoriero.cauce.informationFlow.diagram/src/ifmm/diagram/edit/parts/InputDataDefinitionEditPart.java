 ...
 * @generated
 */
public class InputDataDefinitionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InputDataDefinitionEditPart(View view) {
		super(view);
	}
			...
			parser = InformationFlowParserProvider
					.getParser(
							...
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.InputDataDefinitionEditPart.VISUAL_ID));
		}
		return parser;
	}
