 ...
 * @generated
 */
public class DevicePlatformNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DevicePlatformNameEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.DevicePlatformNameEditPart.VISUAL_ID));
		}
		return parser;
	}
