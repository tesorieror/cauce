 ...
 * @generated
 */
public class VariableDataDefinitionNameDefinitionEditPart extends
	 ...
	 * @generated
	 */
	public VariableDataDefinitionNameDefinitionEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.VariableDataDefinitionNameDefinitionEditPart.VISUAL_ID));
		}
		return parser;
	}
