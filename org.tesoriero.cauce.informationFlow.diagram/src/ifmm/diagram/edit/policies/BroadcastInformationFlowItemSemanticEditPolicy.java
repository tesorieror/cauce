 ...
 * @generated
 */
public class BroadcastInformationFlowItemSemanticEditPolicy extends
		InformationFlowBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public BroadcastInformationFlowItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (InformationFlowVisualIDRegistry.getVisualID(incomingLink) == EntityToBroadcastInformationFlowEdgeEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (InformationFlowVisualIDRegistry.getVisualID(outgoingLink) == BroadcastInformationFlowToEntityEdgeEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
