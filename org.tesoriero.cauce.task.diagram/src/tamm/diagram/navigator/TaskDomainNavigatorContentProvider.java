 ...
 * @generated
 */
public class TaskDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public TaskDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof TaskDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((TaskDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new TaskDomainNavigatorItem((EObject) objects[i],
