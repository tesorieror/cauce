 ...
 * @generated
 */
public class ProgrammingLanguageNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ProgrammingLanguageNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = DeploymentParserProvider
					.getParser(
							DeploymentElementTypes.ProgrammingLanguage_2001,
							getParserElement(),
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.ProgrammingLanguageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
