...
/**
 * This is the item provider adapter for a {@link demm.Platform} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlatformItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemmPackage.Literals.PLATFORM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Platform_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Platform_id_feature", "_UI_Platform_type"),
				 DemmPackage.Literals.PLATFORM__ID,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Platform.class)) {
			case DemmPackage.PLATFORM__NAME:
			case DemmPackage.PLATFORM__ID:
