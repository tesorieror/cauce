 ...
 * @generated
 */
public class ContextAwareEntityReferenceItemSemanticEditPolicy extends
		SpaceReferenceBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ContextAwareEntityReferenceItemSemanticEditPolicy() {
		super(SpaceReferenceElementTypes.ContextAwareEntityReference_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (SpaceReferenceVisualIDRegistry.getVisualID(incomingLink) == SpaceToEntityReferenceDependencyEditPart.VISUAL_ID) {
