 ...
 * @generated
 */
public class ReferentialSpaceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ReferentialSpaceNameEditPart(View view) {
		super(view);
	}
			...
			parser = SpaceReferenceParserProvider
					.getParser(
							...
							SpaceReferenceVisualIDRegistry
									.getType(rsmm.diagram.edit.parts.ReferentialSpaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
