 ...
 * @generated
 */
public class ProtocolVersionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProtocolVersionEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.ProtocolVersionEditPart.VISUAL_ID));
		}
		return parser;
	}
