...
import ecmm.diagram.part.EntityContextDiagramEditorUtil;

/**
 * @generated
 */
public class EntityContextMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = EntityContextDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			EntityContextDiagramEditorUtil.selectElementsInDiagram(editor,
