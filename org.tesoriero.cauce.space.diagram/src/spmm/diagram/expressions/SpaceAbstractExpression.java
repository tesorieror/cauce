 ...
 * @generated
 */
public abstract class SpaceAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = SpaceDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected SpaceAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
