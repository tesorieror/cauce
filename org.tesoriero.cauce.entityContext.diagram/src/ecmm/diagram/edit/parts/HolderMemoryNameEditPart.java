 ...
 * @generated
 */
public class HolderMemoryNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HolderMemoryNameEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.HolderMemoryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
