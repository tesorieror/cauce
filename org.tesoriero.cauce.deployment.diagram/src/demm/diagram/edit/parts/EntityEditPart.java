...
import demm.diagram.edit.policies.EntityItemSemanticEditPolicy;
...
public class EntityEditPart extends ShapeNodeEditPart {
	...
	public class EntityFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureEntityNameLabelFigure;
		...
		private void createContents() {
			...
			fFigureEntityNameLabelFigure = new WrappingLabel();

			fFigureEntityNameLabelFigure.setText("<...>");

			this.add(fFigureEntityNameLabelFigure, BorderLayout.CENTER);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEntityNameLabelFigure() {
			return fFigureEntityNameLabelFigure;
		}
