...
/**
 * This is the item provider adapter for a {@link tamm.PreCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PreConditionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PreCondition_ongoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PreCondition_ongoing_feature", "_UI_PreCondition_type"),
				 TammPackage.Literals.PRE_CONDITION__ONGOING,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_PreCondition_type") + " " + preCondition.getId();
	}
