 ...
 * @generated
 */
public class PostConditionSocialExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PostConditionSocialExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PostConditionSocialExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
