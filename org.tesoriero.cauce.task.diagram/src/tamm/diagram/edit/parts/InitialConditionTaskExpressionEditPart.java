 ...
 * @generated
 */
public class InitialConditionTaskExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public InitialConditionTaskExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.InitialConditionTaskExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
