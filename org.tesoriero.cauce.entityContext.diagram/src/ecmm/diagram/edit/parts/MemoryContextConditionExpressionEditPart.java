 ...
 * @generated
 */
public class MemoryContextConditionExpressionEditPart extends
	 ...
	 * @generated
	 */
	public MemoryContextConditionExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.MemoryContextConditionExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
