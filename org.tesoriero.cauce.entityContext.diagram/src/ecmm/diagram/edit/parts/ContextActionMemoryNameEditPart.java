 ...
 * @generated
 */
public class ContextActionMemoryNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ContextActionMemoryNameEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.ContextActionMemoryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
