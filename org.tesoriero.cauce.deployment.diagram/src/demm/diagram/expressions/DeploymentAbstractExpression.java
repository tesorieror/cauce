 ...
 * @generated
 */
public abstract class DeploymentAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = DeploymentDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected DeploymentAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
