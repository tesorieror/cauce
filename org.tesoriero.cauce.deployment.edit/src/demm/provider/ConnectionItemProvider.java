...
/**
 * This is the item provider adapter for a {@link demm.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemmPackage.Literals.CONNECTION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DemmPackage.Literals.CONNECTION__ID,
				 true,
				 false,
				 false,
	...
	protected void addOngoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_ongoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_ongoing_feature", "_UI_Connection_type"),
				 DemmPackage.Literals.CONNECTION__ONGOING,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIncomingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_incoming_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_incoming_feature", "_UI_Connection_type"),
				 DemmPackage.Literals.CONNECTION__INCOMING,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DemmPackage.Literals.CONNECTION__PLATFORMS);
			childrenFeatures.add(DemmPackage.Literals.CONNECTION__INFORMATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DemmPackage.Literals.CONNECTION__PLATFORMS,
				 DemmFactory.eINSTANCE.createConnectionPlatform()));

		newChildDescriptors.add
			(createChildParameter
				(DemmPackage.Literals.CONNECTION__INFORMATION,
				 DemmFactory.eINSTANCE.createInformation()));
	}
