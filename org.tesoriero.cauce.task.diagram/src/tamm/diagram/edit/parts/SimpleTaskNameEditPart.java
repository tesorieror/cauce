 ...
 * @generated
 */
public class SimpleTaskNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SimpleTaskNameEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.SimpleTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
