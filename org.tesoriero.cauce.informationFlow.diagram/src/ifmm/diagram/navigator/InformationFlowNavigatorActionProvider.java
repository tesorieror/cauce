...
import ifmm.diagram.part.InformationFlowDiagramEditor;
 ...
 * @generated
 */
public class InformationFlowNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof InformationFlowNavigatorItem) {
					selectedElement = ((InformationFlowNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, InformationFlowDiagramEditor.ID);
