 ...
 * @generated
 */
public class EntityContextViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return SystemContextEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EntityContextVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = EntityContextVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!EntityContextElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != EntityContextVisualIDRegistry
				...
				if (!SystemContextEditPart.MODEL_ID
						.equals(EntityContextVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return EntityContextEditPart.VISUAL_ID == visualID
				|| HolderMemoryEditPart.VISUAL_ID == visualID
				|| LogicMemoryEditPart.VISUAL_ID == visualID
				|| TimeMemoryEditPart.VISUAL_ID == visualID
				|| StackMemoryEditPart.VISUAL_ID == visualID
				|| DictionaryMemoryEditPart.VISUAL_ID == visualID
				|| ContextSituationEditPart.VISUAL_ID == visualID
				|| MemoryContextConditionEditPart.VISUAL_ID == visualID
				|| SensingContextConditionEditPart.VISUAL_ID == visualID
				|| ContextActionEditPart.VISUAL_ID == visualID
				|| VariableDataDefinitionEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EntityContextVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(SystemContextEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = EntityContextVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case EntityContextEditPart.VISUAL_ID:
			return createEntityContext_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case HolderMemoryEditPart.VISUAL_ID:
			return createHolderMemory_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case LogicMemoryEditPart.VISUAL_ID:
			return createLogicMemory_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case TimeMemoryEditPart.VISUAL_ID:
			return createTimeMemory_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case StackMemoryEditPart.VISUAL_ID:
			return createStackMemory_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		case DictionaryMemoryEditPart.VISUAL_ID:
			return createDictionaryMemory_3005(domainElement, containerView,
					index, persisted, preferencesHint);
		case ContextSituationEditPart.VISUAL_ID:
			return createContextSituation_3006(domainElement, containerView,
					index, persisted, preferencesHint);
		case MemoryContextConditionEditPart.VISUAL_ID:
			return createMemoryContextCondition_3007(domainElement,
					containerView, index, persisted, preferencesHint);
		case SensingContextConditionEditPart.VISUAL_ID:
			return createSensingContextCondition_3008(domainElement,
					containerView, index, persisted, preferencesHint);
		case ContextActionEditPart.VISUAL_ID:
			return createContextAction_3009(domainElement, containerView,
					index, persisted, preferencesHint);
		case VariableDataDefinitionEditPart.VISUAL_ID:
			return createVariableDataDefinition_3010(domainElement,
					containerView, index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EntityContextVisualIDRegistry.getVisualID(elementTypeHint)) {
		}
	 ...
	 * @generated
	 */
	public Node createEntityContext_2001(EObject domainElement,
		...
		node.setType(EntityContextVisualIDRegistry
		...
		Node label5020 = createLabel(node,
				EntityContextVisualIDRegistry
						.getType(EntityContextIdEditPart.VISUAL_ID));
		createCompartment(node,
				EntityContextVisualIDRegistry
						.getType(EntityContextStateEditPart.VISUAL_ID), true,
				true, true, true);
		createCompartment(node,
				EntityContextVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createHolderMemory_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		Node label5002 = createLabel(node,
				EntityContextVisualIDRegistry
						.getType(HolderMemoryIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createLogicMemory_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5004 = createLabel(node,
				EntityContextVisualIDRegistry
						.getType(LogicMemoryIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createTimeMemory_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5006 = createLabel(node,
				EntityContextVisualIDRegistry
						.getType(TimeMemoryIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createStackMemory_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5008 = createLabel(node,
				EntityContextVisualIDRegistry
						.getType(StackMemoryIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createDictionaryMemory_3005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5010 = createLabel(node,
				EntityContextVisualIDRegistry
						.getType(DictionaryMemoryIdEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createContextSituation_3006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5017 = createLabel(node,
				EntityContextVisualIDRegistry
						.getType(ContextSituationIdEditPart.VISUAL_ID));
		createCompartment(node,
				EntityContextVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createMemoryContextCondition_3007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5012 = createLabel(
				node,
				EntityContextVisualIDRegistry
						.getType(MemoryContextConditionMemoryNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createSensingContextCondition_3008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createContextAction_3009(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5015 = createLabel(node,
				EntityContextVisualIDRegistry
						.getType(ContextActionMemoryNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createVariableDataDefinition_3010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!SystemContextEditPart.MODEL_ID
				.equals(EntityContextVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", SystemContextEditPart.MODEL_ID); //$NON-NLS-1$
