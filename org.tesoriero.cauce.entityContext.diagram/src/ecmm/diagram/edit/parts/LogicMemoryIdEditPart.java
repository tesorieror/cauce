 ...
 * @generated
 */
public class LogicMemoryIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LogicMemoryIdEditPart(View view) {
		super(view);
	}
			...
			parser = EntityContextParserProvider
					.getParser(
							...
							EntityContextVisualIDRegistry
									.getType(ecmm.diagram.edit.parts.LogicMemoryIdEditPart.VISUAL_ID));
		}
		return parser;
	}
