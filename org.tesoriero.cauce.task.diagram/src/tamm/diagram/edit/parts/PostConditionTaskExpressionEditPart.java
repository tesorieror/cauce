 ...
 * @generated
 */
public class PostConditionTaskExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PostConditionTaskExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = TaskParserProvider
					.getParser(
							...
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.PostConditionTaskExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
