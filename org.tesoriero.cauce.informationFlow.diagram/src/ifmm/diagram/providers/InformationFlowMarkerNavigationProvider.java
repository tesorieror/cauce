...
import ifmm.diagram.part.InformationFlowDiagramEditorUtil;
 ...
 * @generated
 */
public class InformationFlowMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = InformationFlowDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			InformationFlowDiagramEditorUtil.selectElementsInDiagram(editor,
