 ...
 * @generated
 */
public class OutputDataDefinition2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OutputDataDefinition2EditPart(View view) {
		super(view);
	}
			...
			parser = InformationFlowParserProvider
					.getParser(
							...
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.OutputDataDefinition2EditPart.VISUAL_ID));
		}
		return parser;
	}
