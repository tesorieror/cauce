 ...
 * @generated
 */
public class ContextAwareEntityIdEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ContextAwareEntityIdEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new InformationFlowTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return InformationFlowElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = InformationFlowParserProvider
					.getParser(
							InformationFlowElementTypes.ContextAwareEntity_2003,
							getParserElement(),
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.ContextAwareEntityIdEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					InformationFlowEditPartFactory
