 ...
 * @generated
 */
public class PointToPointInformationFlowIdEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PointToPointInformationFlowIdEditPart(View view) {
		super(view);
	}
			...
			parser = InformationFlowParserProvider
					.getParser(
							...
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.PointToPointInformationFlowIdEditPart.VISUAL_ID));
		}
		return parser;
	}
