 ...
 * @generated
 */
public class BroadcastInformationFlowNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public BroadcastInformationFlowNameEditPart(View view) {
		super(view);
	}
			...
			parser = InformationFlowParserProvider
					.getParser(
							...
							InformationFlowVisualIDRegistry
									.getType(ifmm.diagram.edit.parts.BroadcastInformationFlowNameEditPart.VISUAL_ID));
		}
		return parser;
	}
