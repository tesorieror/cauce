...
import rsmm.diagram.part.SpaceReferenceDiagramEditorUtil;

/**
 * @generated
 */
public class SpaceReferenceMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = SpaceReferenceDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			SpaceReferenceDiagramEditorUtil.selectElementsInDiagram(editor,
