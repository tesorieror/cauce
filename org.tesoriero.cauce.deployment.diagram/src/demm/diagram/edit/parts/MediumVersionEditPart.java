 ...
 * @generated
 */
public class MediumVersionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MediumVersionEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.MediumVersionEditPart.VISUAL_ID));
		}
		return parser;
	}
