 ...
 * @generated
 */
public class InitialConditionDataExpressionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public InitialConditionDataExpressionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new TaskTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TaskParserProvider
					.getParser(
							TaskElementTypes.InitialCondition_2007,
							getParserElement(),
							TaskVisualIDRegistry
									.getType(tamm.diagram.edit.parts.InitialConditionDataExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					TaskEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
