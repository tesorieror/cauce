 ...
 * @generated
 */
public class OperatingSystemVersionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OperatingSystemVersionEditPart(View view) {
		super(view);
	}
			...
			parser = DeploymentParserProvider
					.getParser(
							...
							DeploymentVisualIDRegistry
									.getType(demm.diagram.edit.parts.OperatingSystemVersionEditPart.VISUAL_ID));
		}
		return parser;
	}
